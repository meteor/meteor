...
<table>
  ...
  <tbody>
    <tr><td>`""` or `null` or `{}`</td></tr>
    <tr><td>`"checked"` or `{checked: ""}`</td><td>`checked`</td></tr>
    <tr><td>`{checked: "", 'class': "foo"}`</td><td>`checked  class=foo`</td></tr>
    <tr><td>`"checked class=foo"`</td><td>ERROR, string is not an attribute name</td></tr>
  </tbody>
</table>
