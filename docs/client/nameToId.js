...
nameToId = {
  ...
  "Meteor.Collection#find": "find",
  "Meteor.status": "meteor_status",
  "Meteor.user": "meteor_user",
  "Meteor.userId": "meteor_userid",
  "Meteor.loggingIn": "meteor_loggingin",
  "Meteor.Collection.Cursor#observe": "observe",
  "Meteor.Collection.Cursor#observeChanges": "observe_changes",
  ...
  "Meteor.Collection#insert": "insert",
  "Meteor.Collection#update": "update",
  "Meteor.Collection#remove": "remove",
  "Meteor.reconnect": "meteor_reconnect",
  "Meteor.methods": "meteor_methods",
  "Meteor.disconnect": "meteor_disconnect",
  "DDP.connect": "ddp_connect",
  "Meteor.Collection.ObjectID": "collection_object_id",
  "Meteor.Collection#allow": "allow",
  "Meteor.publish": "meteor_publish",
  "Meteor.Collection#deny": "deny",
  "Meteor.Collection#upsert": "upsert",
  "Meteor.Collection.Cursor#forEach": "foreach",
  "Meteor.Collection.Cursor#map": "map",
  "Meteor.Collection.Cursor#fetch": "fetch",
  "EJSON.equals": "ejson_equals",
  "Meteor.Collection#findOne": "findone",
  ...
  "Deps.afterFlush": "deps_afterflush",
  "Deps.active": "deps_active",
  "Deps.Dependency#depend": "dependency_depend",
  "Deps.onInvalidate": "deps_oninvalidate",
  "Deps.Computation#onInvalidate": "computation_oninvalidate",
  "Deps.Computation#stop": "computation_stop",
  "Deps.currentComputation": "deps_currentcomputation",
  ...
  "Meteor.Collection.Cursor#count": "count",
  ...
  "Deps.nonreactive": "deps_nonreactive",
  "Deps.Computation#invalidate": "computation_invalidate",
  "Deps.Computation#stopped": "computation_stopped",
  "Deps.Computation#invalidated": "computation_invalidated",
  "Deps.Computation#firstRun": "computation_firstrun",
  "Deps.Dependency#changed": "dependency_changed",
  "Deps.Dependency#hasDependents": "dependency_hasdependents",
