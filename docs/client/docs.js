...
var toc = [
  ...
  "API", [
    ...
    {name: "Accounts", id: "accounts_api"}, [
      ...
      {name: "Accounts.loginWithFacebook", id: "accounts_loginwithexternalservice"},
      {name: "Accounts.loginWithGithub", id: "accounts_loginwithexternalservice"},
      {name: "Accounts.loginWithGoogle", id: "accounts_loginwithexternalservice"},
      {name: "Accounts.loginWithMeetup", id: "accounts_loginwithexternalservice"},
      {name: "Accounts.loginWithTwitter", id: "accounts_loginwithexternalservice"},
      {name: "Accounts.loginWithWeibo", id: "accounts_loginwithexternalservice"},
      {type: "spacer"},
