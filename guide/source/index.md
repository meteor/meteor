...
> Meteor 2.x is running on a deprecated Node.js version (14). Meteor 3.0 is in the works, and it will run on the latest Node.js version. For more information, please consult our [migration guide](/3.0-migration.html).
