...
import isMeteorCall from '../util/ast/isMeteorCall'
import {isInServerBlock, isInClientBlock} from '../util/ast/isInBlock'
...
module.exports = (getMeta) => context => {
  const {isInMeteorProject, env} = getMeta(context.getFilename())

  if (!isInMeteorProject) {
    return {}
  }
