  ...
  Commands.push({
    ...
    func: function (argv) {
      ...
      if (updated) {
        ...
        // If the engine for release is different, then engineSpringboard execs
        // and does not return. Otherwise, keeps going.
      }

      if (updatedFrom !== releaseVersion) {
        console("XXX Globally updated from " + updatedFrom + " to "
                + releaseVersion);
