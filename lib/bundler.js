...
var PackageInstance = function (pkg, bundle) {
  ...
  self.api = {
    ...
    useNpm: function (npmDependencies) {
      ...
      var packageNpmDir = path.join(self.pkg.source_root, '.npm');
      ...
      meteorNpm.updateDependencies(self.pkg.name, packageNpmDir, npmDependencies);
      ...
      self.bundle.nodeModulesDirs[relNodeModulesPath] = nodeModulesPath;
    },
