...
* [dispatch:mocha](https://atmospherejs.com/dispatch/mocha) Runs server package or app tests with Mocha, and client package or app tests with PhantomJS or other supported browser, and reports all results in the server console. Can be used for running tests on a CI server. Has a watch mode.
