...
const _makeChangedFieldsCache = new Map();
...
DiffSequence.makeChangedFields = function(newDoc, oldDoc){
  ...
  if(_makeChangedFieldsCache.has(getHash)){
    return _makeChangedFieldsCache.get(getHash)
  }
  else {
    ...
    DiffSequence._memoize(getHash, newObject)
    return newObject; 
  }
}
...
DiffSequence._memoize = function(key, value){
  _makeChangedFieldsCache.size > 25 && _makeChangedFieldsCache.clear(); 
  _makeChangedFieldsCache.set(key, value);
},

DiffSequence._generateHashFromArray = function(array){
  let objectString = "";
