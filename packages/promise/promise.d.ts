export declare class Promise<T> extends globalThis.Promise<T> {
  ...
  static async<Fn extends (this: This, ...args: Args) => unknown, This, Args extends unknown[]>(
    fn: Fn,
  ...
  >(fn: Fn, context: This, args: Args, allowReuseOfCurrentFiber?: boolean): Promise<ReturnType<Fn>>;
  /** @deprecated Fiber-era declaration retained for Meteor 3.x compatibility. */
  ...
  done(onFulfilled?: (value: T) => void, onRejected?: (reason: unknown) => void): void;
}
