SeededRandom = function (seed) {
  // seed may be a string or any type
  if (!(this instanceof SeededRandom)) return new SeededRandom(seed);
...
SeededRandom.prototype.nextIdentifier = function (optLen) {
  ...
  for (let i = 0; i < len; i++) letters.push(String.fromCharCode(this.nextIntBetween(97, 122)));
  return letters.join("");
};
