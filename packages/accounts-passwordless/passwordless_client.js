 ...
 * @locus Client
 * @param {Object|String} selector A username or email string, or an object with exactly one of `id`, `username` or `email`.
 ...
 * @param {String|Object} options.selector An email address or username string, or an object with exactly one of `id`, `username` or `email`.
