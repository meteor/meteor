...
Tinytest.add("minimongo - selector_compiler", function (test) {
  ...
  match({"a.b": {$near: [4.104123115539551,51.190102913249426]}},{a: {b: [{lon:4.0970976, lat:51.1935336}]}});
  match({"a.b": {$near: [-74.0059731,40.7143528],$maxDistance:1000000000000}},{a: {b: [{lon:4.0970976,lat:51.1935336}]}}); 
  nomatch({"a.b": {$near: [-74.0059731,40.7143528]}}, {a: {b: [{lon:4.0970976,lat:51.1935336}]}});

  match({"a.b" : {$within : {$box : [[0,0],[100,100]]}}}, {a: {b: [{x:50,y:50}]}});
  match({"a.b" : {$within : {$box : [[0,0],[36,100]]}}}, {a: {b: [{x:20,y:50}]}});
  nomatch({"a.b" : {$within : {$box : [[10,25],[36,100]]}}}, {a: {b: [{x:50,y:50}]}});
  nomatch({"a.b" : {$within : {$box : [[0,0],[100,100]]}}}, {a: {b: [{x:120,y:30}]}});
  
  match({"a.b" : {$within : {$circle : [[0,0],100]}}}, {a: {b: [{x:50,y:50}]}});
  match({"a.b" : {$within : {$circle: [[25,25],50]}}}, {a: {b: [{x:20,y:50}]}});
  nomatch({"a.b" : {$within : {$circle : [[0,0],25]}}}, {a: {b: [{x:50,y:50}]}});
  nomatch({"a.b" : {$within : {$circle: [[0,0],100]}}}, {a: {b: [{x: 120,y:30}]}});
  
  match({"a.b" : {$within : {$polygon : [[0,0], [0,50], [50,50], [50,0]]}}}, {a: {b: [{x:25,y:25}]}});
  match({"a.b" : {$within : {$polygon: [[100,120], [100,100], [120,100], [240,200]]}}}, {a: {b: [{x:101,y:101}]}});
  nomatch({"a.b" : {$within : {$polygon : [[100,120], [100,100], [120,100], [240,200]]}}}, {a: {b: [{x:50,y:50}]}});
  nomatch({"a.b" : {$within : {$polygon: [[100,120], [100,100], [120,100], [240,200]]}}}, {a: {b: [{x:120,y:30}]}});
