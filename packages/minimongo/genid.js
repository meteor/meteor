...
///
/// XXX probably needs to be nuked from orbit for minimongo
///
/// XXX this code is linked to from Sky.genId on the client, and copied
/// to sky_server.js for the server.
Collection._genId_counter = 0;
Collection._genId = function () {
  var key = (Collection._genId_counter++) + "#";
  key += (new Date()).getTime() + "#";
  key += Math.random() + "#";
  key += Math.random() + "#";
  key += Math.random() + "#";
  var id = Collection._MD5(key);
  return id;
};
...
Collection._MD5 = function (string) {
