Tinytest.add('minifier-js - verify how esbuild handles an empty string', (test) => {
...
Tinytest.add('minifier-js - verify esbuild error object has the fields we use for reporting errors to users', (test) => {
  let result;
  try {
