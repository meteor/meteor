...
Tinytest.add("pbsolver - buggy optimization", function (test) {
  ...
  var allPackageVersions = [
    "data-mapper 1.2.0",
    "dm-transactions 1.0.1", "dm-transactions 1.0.2", "dm-transactions 1.1.0",
    "dm-transactions 1.2.0",
    "dm-constraints 0.9.11", "dm-constraints 0.10.0", "dm-constraints 0.10.1",
    "dm-constraints 0.10.2", "dm-constraints 1.0.1", "dm-constraints 1.0.2",
    "dm-constraints 1.1.0", "dm-constraints 1.2.0",
    "dm-types 0.9.11", "dm-types 0.10.0", "dm-types 0.10.1",
    "dm-types 0.10.2", "dm-types 1.1.0", "dm-types 1.2.0",
    "dm-types 1.2.1", "dm-types 1.2.2",
    "multi-json 0.0.2", "multi-json 0.0.3", "multi-json 0.0.4",
    "multi-json 0.0.5", "multi-json 1.8.4", "multi-json 1.9.0",
    "multi-json 1.9.1", "multi-json 1.9.2",
    "json 0.4.0", "json 0.4.1", "json 0.4.2",
    "json 0.4.3", "json 1.7.6", "json 1.7.7",
    "json 1.8.0", "json 1.8.1",
    "stringex 1.3.3", "stringex 1.4.0", "stringex 1.5.0",
    "stringex 1.5.1", "stringex 2.4.1", "stringex 2.4.2",
    "stringex 2.5.0", "stringex 2.5.1",
    "uuidtools 0.1.1", "uuidtools 0.1.2", "uuidtools 0.1.3",
    "uuidtools 0.1.4", "uuidtools 1.0.4", "uuidtools 1.0.5",
    "uuidtools 1.0.6", "uuidtools 1.0.7", "uuidtools 2.1.1",
    "uuidtools 2.1.2", "uuidtools 2.1.3", "uuidtools 2.1.4",
    "launchy 0.4.2",
    "rspec 0.20.0", "rspec 1.20.0", "rspec 2.20.0", "rspec 3.20.0",
    "rake 12.0.0",
    "json-pure 1.7.6", "json-pure 1.7.7", "json-pure 1.8.0",
    "json-pure 1.8.1", "fastercsv 0.1.8", "fastercsv 0.1.9",
    "fastercsv 0.2.0", "fastercsv 0.2.1", "fastercsv 1.5.1",
    "fastercsv 1.5.3", "fastercsv 1.5.4", "fastercsv 1.5.5",
    "bcrypt-ruby 1.0.0", "bcrypt-ruby 2.1.1", "bcrypt-ruby 2.1.2",
    "bcrypt-ruby 2.1.3", "bcrypt-ruby 2.1.4", "bcrypt-ruby 3.1.2",
    "bcrypt-ruby 3.1.3", "bcrypt-ruby 3.1.4", "bcrypt-ruby 3.1.5",
    "bcrypt 3.1.3", "bcrypt 3.1.6", "bcrypt 3.1.7",
    "addressable 0.1.0", "addressable 0.1.1", "addressable 0.1.2",
    "addressable 1.0.1", "addressable 1.0.2", "addressable 1.0.3",
    "addressable 1.0.4", "addressable 2.3.3", "addressable 2.3.4",
    "addressable 2.3.5", "addressable 2.3.6",
    "dm-validations 0.9.11", "dm-validations 0.10.0", "dm-validations 0.10.1",
    "dm-validations 0.10.2", "dm-validations 1.0.1", "dm-validations 1.0.2",
    "dm-validations 1.1.0", "dm-validations 1.2.0",
    "dm-timestamps 0.9.11", "dm-timestamps 0.10.0", "dm-timestamps 0.10.1",
    "dm-timestamps 0.10.2", "dm-timestamps 1.0.1", "dm-timestamps 1.0.2",
    "dm-timestamps 1.1.0", "dm-timestamps 1.2.0",
    "dm-serializer 0.9.11", "dm-serializer 0.10.0", "dm-serializer 0.10.1",
    "dm-serializer 0.10.2", "dm-serializer 1.1.0", "dm-serializer 1.2.0",
    "dm-serializer 1.2.1", "dm-serializer 1.2.2",
    "dm-migrations 0.9.11", "dm-migrations 0.10.0", "dm-migrations 0.10.1",
    "dm-migrations 0.10.2", "dm-migrations 1.0.1", "dm-migrations 1.0.2",
    "dm-migrations 1.1.0", "dm-migrations 1.2.0",
    "dm-aggregates 0.9.11", "dm-aggregates 0.10.0", "dm-aggregates 0.10.1",
    "dm-aggregates 0.10.2", "dm-aggregates 1.0.1", "dm-aggregates 1.0.2",
    "dm-aggregates 1.1.0", "dm-aggregates 1.2.0",
    "dm-core 0.9.11", "dm-core 0.10.0", "dm-core 0.10.1",
    "dm-core 0.10.2", "dm-core 1.0.2", "dm-core 1.1.0",
    "dm-core 1.2.0", "dm-core 1.2.1",
    "data-objects 0.10.11", "data-objects 0.10.12",
    "data-objects 0.10.13", "data-objects 0.10.14",
    "capistrano 1.3.1", "capistrano 1.4.0",
    "capistrano 1.4.1", "capistrano 1.4.2",
    "capistrano 2.15.2", "capistrano 2.15.3",
    "capistrano 2.15.4", "capistrano 2.15.5",
    "capistrano 3.0.0", "capistrano 3.0.1", "capistrano 3.1.0",
    "net-ssh-gateway 1.0.0", "net-ssh-gateway 1.0.1",
    "net-ssh-gateway 1.1.0", "net-ssh-gateway 1.2.0",
    "echoe 1.0.0",
    "net-scp 1.0.4", "net-scp 1.1.0", "net-scp 1.1.1", "net-scp 1.1.2",
    "highline 0.3.0", "highline 0.4.0", "highline 0.5.0",
    "highline 0.6.1", "highline 1.6.18", "highline 1.6.19",
    "highline 1.6.20", "highline 1.6.21",
    "net-sftp 0.5.0", "net-sftp 0.9.0", "net-sftp 1.0.0",
    "net-sftp 1.0.1", "net-sftp 1.1.0", "net-sftp 1.1.1",
    "net-sftp 2.0.5", "net-sftp 2.1.0", "net-sftp 2.1.1", "net-sftp 2.1.2",
    "net-ssh 0.5.0", "net-ssh 0.6.0", "net-ssh 0.9.0",
    "net-ssh 1.1.1", "net-ssh 1.1.2", "net-ssh 1.1.3",
    "net-ssh 1.1.4", "net-ssh 2.6.7", "net-ssh 2.6.8",
