...
Tinytest.add("pbsolver - buggy optimization", function (test) {
  ...
  var optimizeCosts = {"data-mapper 1.2.0":[1],"dm-transactions 1.0.1":[1],"dm-transactions 1.0.2":[1],"dm-transactions 1.1.0":[1],"dm-transactions 1.2.0":[1],"dm-constraints 0.9.11":[1],"dm-constraints 0.10.0":[1],"dm-constraints 0.10.1":[1],"dm-constraints 0.10.2":[1],"dm-constraints 1.0.1":[1],"dm-constraints 1.0.2":[1],"dm-constraints 1.1.0":[1],"dm-constraints 1.2.0":[1],"dm-types 0.9.11":[1],"dm-types 0.10.0":[1],"dm-types 0.10.1":[1],"dm-types 0.10.2":[1],"dm-types 1.1.0":[1],"dm-types 1.2.0":[1],"dm-types 1.2.1":[1],"dm-types 1.2.2":[1],"multi-json 0.0.2":[1],"multi-json 0.0.3":[1],"multi-json 0.0.4":[1],"multi-json 0.0.5":[1],"multi-json 1.8.4":[1],"multi-json 1.9.0":[1],"multi-json 1.9.1":[1],"multi-json 1.9.2":[1],"json 0.4.0":[1],"json 0.4.1":[1],"json 0.4.2":[1],"json 0.4.3":[1],"json 1.7.6":[1],"json 1.7.7":[1],"json 1.8.0":[1],"json 1.8.1":[1],"stringex 1.3.3":[1],"stringex 1.4.0":[1],"stringex 1.5.0":[1],"stringex 1.5.1":[1],"stringex 2.4.1":[1],"stringex 2.4.2":[1],"stringex 2.5.0":[1],"stringex 2.5.1":[1],"uuidtools 0.1.1":[1],"uuidtools 0.1.2":[1],"uuidtools 0.1.3":[1],"uuidtools 0.1.4":[1],"uuidtools 1.0.4":[1],"uuidtools 1.0.5":[1],"uuidtools 1.0.6":[1],"uuidtools 1.0.7":[1],"uuidtools 2.1.1":[1],"uuidtools 2.1.2":[1],"uuidtools 2.1.3":[1],"uuidtools 2.1.4":[1],"launchy 0.4.2":[1],"rspec 0.20.0":[1],"rspec 1.20.0":[1],"rspec 2.20.0":[1],"rspec 3.20.0":[1],"rake 12.0.0":[1],"json-pure 1.7.6":[1],"json-pure 1.7.7":[1],"json-pure 1.8.0":[1],"json-pure 1.8.1":[1],"fastercsv 0.1.8":[1],"fastercsv 0.1.9":[1],"fastercsv 0.2.0":[1],"fastercsv 0.2.1":[1],"fastercsv 1.5.1":[1],"fastercsv 1.5.3":[1],"fastercsv 1.5.4":[1],"fastercsv 1.5.5":[1],"bcrypt-ruby 1.0.0":[1],"bcrypt-ruby 2.1.1":[1],"bcrypt-ruby 2.1.2":[1],"bcrypt-ruby 2.1.3":[1],"bcrypt-ruby 2.1.4":[1],"bcrypt-ruby 3.1.2":[1],"bcrypt-ruby 3.1.3":[1],"bcrypt-ruby 3.1.4":[1],"bcrypt-ruby 3.1.5":[1],"bcrypt 3.1.3":[1],"bcrypt 3.1.6":[1],"bcrypt 3.1.7":[1],"addressable 0.1.0":[1],"addressable 0.1.1":[1],"addressable 0.1.2":[1],"addressable 1.0.1":[1],"addressable 1.0.2":[1],"addressable 1.0.3":[1],"addressable 1.0.4":[1],"addressable 2.3.3":[1],"addressable 2.3.4":[1],"addressable 2.3.5":[1],"addressable 2.3.6":[1],"dm-validations 0.9.11":[1],"dm-validations 0.10.0":[1],"dm-validations 0.10.1":[1],"dm-validations 0.10.2":[1],"dm-validations 1.0.1":[1],"dm-validations 1.0.2":[1],"dm-validations 1.1.0":[1],"dm-validations 1.2.0":[1],"dm-timestamps 0.9.11":[1],"dm-timestamps 0.10.0":[1],"dm-timestamps 0.10.1":[1],"dm-timestamps 0.10.2":[1],"dm-timestamps 1.0.1":[1],"dm-timestamps 1.0.2":[1],"dm-timestamps 1.1.0":[1],"dm-timestamps 1.2.0":[1],"dm-serializer 0.9.11":[1],"dm-serializer 0.10.0":[1],"dm-serializer 0.10.1":[1],"dm-serializer 0.10.2":[1],"dm-serializer 1.1.0":[1],"dm-serializer 1.2.0":[1],"dm-serializer 1.2.1":[1],"dm-serializer 1.2.2":[1],"dm-migrations 0.9.11":[1],"dm-migrations 0.10.0":[1],"dm-migrations 0.10.1":[1],"dm-migrations 0.10.2":[1],"dm-migrations 1.0.1":[1],"dm-migrations 1.0.2":[1],"dm-migrations 1.1.0":[1],"dm-migrations 1.2.0":[1],"dm-aggregates 0.9.11":[1],"dm-aggregates 0.10.0":[1],"dm-aggregates 0.10.1":[1],"dm-aggregates 0.10.2":[1],"dm-aggregates 1.0.1":[1],"dm-aggregates 1.0.2":[1],"dm-aggregates 1.1.0":[1],"dm-aggregates 1.2.0":[1],"dm-core 0.9.11":[1],"dm-core 0.10.0":[1],"dm-core 0.10.1":[1],"dm-core 0.10.2":[1],"dm-core 1.0.2":[1],"dm-core 1.1.0":[1],"dm-core 1.2.0":[1],"dm-core 1.2.1":[1],"data-objects 0.10.11":[1],"data-objects 0.10.12":[1],"data-objects 0.10.13":[1],"data-objects 0.10.14":[1],"capistrano 1.3.1":[1],"capistrano 1.4.0":[1],"capistrano 1.4.1":[1],"capistrano 1.4.2":[1],"capistrano 2.15.2":[1],"capistrano 2.15.3":[1],"capistrano 2.15.4":[1],"capistrano 2.15.5":[1],"capistrano 3.0.0":[1],"capistrano 3.0.1":[1],"capistrano 3.1.0":[1],"net-ssh-gateway 1.0.0":[1],"net-ssh-gateway 1.0.1":[1],"net-ssh-gateway 1.1.0":[1],"net-ssh-gateway 1.2.0":[1],"echoe 1.0.0":[1],"net-scp 1.0.4":[1],"net-scp 1.1.0":[1],"net-scp 1.1.1":[1],"net-scp 1.1.2":[1],"highline 0.3.0":[1],"highline 0.4.0":[1],"highline 0.5.0":[1],"highline 0.6.1":[1],"highline 1.6.18":[1],"highline 1.6.19":[1],"highline 1.6.20":[1],"highline 1.6.21":[1],"net-sftp 0.5.0":[1],"net-sftp 0.9.0":[1],"net-sftp 1.0.0":[1],"net-sftp 1.0.1":[1],"net-sftp 1.1.0":[1],"net-sftp 1.1.1":[1],"net-sftp 2.0.5":[1],"net-sftp 2.1.0":[1],"net-sftp 2.1.1":[1],"net-sftp 2.1.2":[1],"net-ssh 0.5.0":[1],"net-ssh 0.6.0":[1],"net-ssh 0.9.0":[1],"net-ssh 1.1.1":[1],"net-ssh 1.1.2":[1],"net-ssh 1.1.3":[1],"net-ssh 1.1.4":[1],"net-ssh 2.6.7":[1],"net-ssh 2.6.8":[1],"net-ssh 2.7.0":[1],"net-ssh 2.8.0":[1]};

  var result = solver.optimize(optimizeCosts);
