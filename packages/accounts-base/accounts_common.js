...
export class AccountsCommon {
   ...
   * @param {Boolean} options.useSessionStorage By default login credentials are stored in local storage, setting this to true will switch to using session storage.
   */
  config(options) {
