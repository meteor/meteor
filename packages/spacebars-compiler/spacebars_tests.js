...
Tinytest.add("spacebars - parse", function (test) {
  test.equal(toJS(Spacebars.parse('{{foo}}')),
             'HTMLTools.Special({type: "DOUBLE", path: ["foo"]})');

  test.equal(toJS(Spacebars.parse('{{!foo}}')), 'null');
  test.equal(toJS(Spacebars.parse('x{{!foo}}y')), '"xy"');

  test.equal(toJS(Spacebars.parse('{{#foo}}x{{/foo}}')),
             'HTMLTools.Special({type: "BLOCKOPEN", path: ["foo"], content: "x"})');

  test.equal(toJS(Spacebars.parse('{{#foo}}{{#bar}}{{/bar}}{{/foo}}')),
             'HTMLTools.Special({type: "BLOCKOPEN", path: ["foo"], content: HTMLTools.Special({type: "BLOCKOPEN", path: ["bar"]})})');

  test.equal(toJS(Spacebars.parse('<div>hello</div> {{#foo}}<div>{{#bar}}world{{/bar}}</div>{{/foo}}')),
  ...
  test.equal(toJS(Spacebars.parse('<a {{! x}} b=c{{! x}} {{! x}}></a>')),
             'HTML.A({b: "c"})');
  ...
  test.equal(toJS(Spacebars.parse('<input selected={{!foo}}>')),
             'HTML.INPUT({selected: ""})');
  test.equal(toJS(Spacebars.parse('<input selected={{!foo}}{{!bar}}>')),
             'HTML.INPUT({selected: ""})');
