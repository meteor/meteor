...
wrapDestructiveFsFunc("copyFile", [0, 1]);
const wrappedCopyFile = files.copyFile;
...
files.copyFile = function copyFile(from, to, flags = 0) {
  ...
  if (stat && stat.isFile()) {
    ...
    // into a writable app.
    files.chmod(to, (stat.mode & 0o100) ? 0o777 : 0o666);
  }
};
