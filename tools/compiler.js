...
var compileUnibuild = function (isopk, inputSourceArch, packageLoader,
  ...
  _.each(sourceItems, function (source) {
    ...
    var compileStep = {
       ...
       * @param {String} options.bare Do not wrap this file in a
       * closure, exposing its variables to other files in the
       * package. This overrides any `bare` option on the parent build file.
       * @memberOf CompileStep
       * @instance
       */
      addJavaScript: function (options) {
        ...
        js.push({
          ...
          servePath: path.join(inputSourceArch.pkg.serveRoot, options.path),
          bare: !! (options.bare || fileOptions.bare),
          sourceMap: options.sourceMap
        });
      },
