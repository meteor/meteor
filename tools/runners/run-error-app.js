...
//
// To use, construct an instance of ErrorAppRunner, and then call start() to start it
...
var ErrorAppRunner = function (options) {
  var self = this;

  self.projectContext = options.projectContext;

  // noerote: run-all.js updates port directly
  self.port = options.port;
  self.listenHost = options.listenHost;
  self.mongoUrl = options.mongoUrl;
  self.oplogUrl = options.oplogUrl;
...
_.extend(ErrorAppRunner.prototype, {
...
exports.ErrorAppRunner = ErrorAppRunner;
