...
Rspack's Jest tests live in `packages/rspack/tests/` and run through this shared
environment. Its Meteor package tests remain in `packages/rspack/rspack_tests.js`
and run through Tinytest. The Jest configuration selects package test directories
...
npm run test:unit -- packages/rspack/tests/proxy.test.js
