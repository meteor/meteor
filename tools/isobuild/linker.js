...
Object.assign(File.prototype, {
  ...
  _getClosureHeader() {
    const asyncClosure = this.bundleArch && this.bundleArch.includes("os") && this.isAsync;
...
var getHeader = function (options) {
  ...
  const asyncHeader = module.files.some(({isAsync}) => !!isAsync);
  chunks.push(
