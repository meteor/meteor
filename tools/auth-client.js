...
export function AlreadyPrintedMessageError() {}
...
export function openServiceConnection(serverUrl) {
...
export function handleConnectionError(error, label) {
...
//
export function loggedInConnection(url, domain, sessionType) {
