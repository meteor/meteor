...
**New in Meteor 3.x**: Atmosphere packages can bundle TypeScript type declarations directly. When they do, Meteor automatically includes those types in the auto-generated `.meteor/local/types/packages.d.ts` file.
...
When generating `.meteor/local/types/packages.d.ts`, Meteor looks for type information in this order:
