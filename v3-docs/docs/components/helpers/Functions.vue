...
import { makePrimitiveHTML, comment } from '../scripts/make-primitive-html';
...
<span class="line" v-if="props.scope === 'instance'" v-html="comment(`// This is an instance of ${getInstanceName(props.longname)}`)"></span>
