...
If you have Node installed but don't have Meteor installed, you can install it by running:

```shell
npx meteor
```

Alternatively, if you are running some type of Unix OS such as Mac or Linux then you can install Meteor from the command line this way:
...
Now your app should should scale properly on mobile devices and look like this:
