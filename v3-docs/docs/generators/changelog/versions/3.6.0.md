...
- Meteor now runs applications and build tooling on Node.js 26.10.0 with npm 11.19.0. Validate native dependencies and any code that depends on Node.js runtime behavior before deploying.
