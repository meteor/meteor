...
```bash
meteor update --release 3.5-beta
```
...
- accounts-base@3.2.1-beta350
- ddp-server@3.1.3-beta350
- mongo@2.3.0-beta350
- mongo-decimal@0.2.2-beta350
- oauth1@1.5.3-beta350
- service-configuration@1.3.6-beta350
- sessions@1.2.3-beta350
