...
- **MongoDB Collation Support**, [PR#14188](https://github.com/meteor/meteor/pull/14188)
  - 🌐 Full collation support in `find`, `findOne`, `findOneAsync`, and `observeChanges`
  - 🔤 Locale-aware string comparison in Minimongo via `Intl.Collator`, so client and server behave identically
  - ⚡ Compatible with oplog tailing — case-insensitive queries no longer fall back to polling
